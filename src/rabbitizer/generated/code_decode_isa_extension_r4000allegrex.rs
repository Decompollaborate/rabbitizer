...
impl OpcodeDecoder {
    ...
    pub(crate) const fn decode_isa_extension_r4000allegrex_vfpu4_fmt0_fmt0(
        ...
        mandatory_bits = mandatory_bits.union(mask.mask_value(word));
        let opcode = match mask.get_shifted(word) {
            0x00000 => Opcode::r4000allegrex_vmov_s,
            0x00001 => Opcode::r4000allegrex_vmov_p,
            0x00100 => Opcode::r4000allegrex_vmov_t,
            0x00101 => Opcode::r4000allegrex_vmov_q,
            0x00400 => Opcode::r4000allegrex_vabs_s,
            0x00401 => Opcode::r4000allegrex_vabs_p,
            0x00500 => Opcode::r4000allegrex_vabs_t,
            0x00501 => Opcode::r4000allegrex_vabs_q,
            0x00800 => Opcode::r4000allegrex_vneg_s,
            0x00801 => Opcode::r4000allegrex_vneg_p,
            0x00900 => Opcode::r4000allegrex_vneg_t,
            0x00901 => Opcode::r4000allegrex_vneg_q,
            0x00C01 => Opcode::r4000allegrex_vidt_p,
            0x00D01 => Opcode::r4000allegrex_vidt_q,
            0x01000 => Opcode::r4000allegrex_vsat0_s,
            0x01001 => Opcode::r4000allegrex_vsat0_p,
            0x01100 => Opcode::r4000allegrex_vsat0_t,
            0x01101 => Opcode::r4000allegrex_vsat0_q,
            0x01400 => Opcode::r4000allegrex_vsat1_s,
            0x01401 => Opcode::r4000allegrex_vsat1_p,
            0x01500 => Opcode::r4000allegrex_vsat1_t,
            0x01501 => Opcode::r4000allegrex_vsat1_q,
            0x01800 => Opcode::r4000allegrex_vzero_s,
            0x01801 => Opcode::r4000allegrex_vzero_p,
            0x01900 => Opcode::r4000allegrex_vzero_t,
            0x01901 => Opcode::r4000allegrex_vzero_q,
            0x01C00 => Opcode::r4000allegrex_vone_s,
            0x01C01 => Opcode::r4000allegrex_vone_p,
            0x01D00 => Opcode::r4000allegrex_vone_t,
            0x01D01 => Opcode::r4000allegrex_vone_q,
            _ => Opcode::ALL_INVALID,
        };
        Self {
            opcode,
    ...
    pub(crate) const fn decode_isa_extension_r4000allegrex_vfpu6_fmt7_fmt0(
        ...
        mandatory_bits = mandatory_bits.union(mask.mask_value(word));
        let opcode = match mask.get_shifted(word) {
            0x00001 => Opcode::r4000allegrex_vmmov_p,
            0x00100 => Opcode::r4000allegrex_vmmov_t,
            0x00101 => Opcode::r4000allegrex_vmmov_q,
            0x00C01 => Opcode::r4000allegrex_vmidt_p,
            0x00D00 => Opcode::r4000allegrex_vmidt_t,
            0x00D01 => Opcode::r4000allegrex_vmidt_q,
            0x01801 => Opcode::r4000allegrex_vmzero_p,
            0x01900 => Opcode::r4000allegrex_vmzero_t,
            0x01901 => Opcode::r4000allegrex_vmzero_q,
            0x01C01 => Opcode::r4000allegrex_vmone_p,
            0x01D00 => Opcode::r4000allegrex_vmone_t,
            0x01D01 => Opcode::r4000allegrex_vmone_q,
            _ => Opcode::ALL_INVALID,
        };
        Self {
            opcode,
