...
pub static OPCODE_CATEGORIES: [OpcodeCategoryDescriptor; OPCODE_CATEGORY_COUNT] = {
    ...
    table[OpcodeCategory::R3000GTE_REGIMM as usize] =
        OpcodeCategoryDescriptor::new(concat!("R3000GTE", "_", "REGIMM"));
    table[OpcodeCategory::R3000GTE_COP0 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R3000GTE", "_", "COP0"));
    table[OpcodeCategory::R3000GTE_COP1 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R3000GTE", "_", "COP1"));
    table[OpcodeCategory::R3000GTE_COP2 as usize] =
    ...
    table[OpcodeCategory::R4000ALLEGREX_VFPU4_FMT0_FMT8 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU4_FMT0_FMT8"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU4_FMT0_FMT9 as usize] =
    ...
    table[OpcodeCategory::R4000ALLEGREX_VFPU4_FMT0_COLOR as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU4_FMT0_COLOR"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU4_FMT0_CST as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU4_FMT0_CST"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU4_FMT2 as usize] =
    ...
    table[OpcodeCategory::R4000ALLEGREX_VFPU5 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU5"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU6 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU6"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU6_FMT7 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU6_FMT7"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU6_FMT7_FMT0 as usize] =
        OpcodeCategoryDescriptor::new(concat!("R4000ALLEGREX", "_", "VFPU6_FMT7_FMT0"));
    table[OpcodeCategory::R4000ALLEGREX_VFPU7 as usize] =
