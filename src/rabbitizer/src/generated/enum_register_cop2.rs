...
impl Cop2 {
    pub const fn try_from_u32(value: u32) -> Result<Self, IntRegisterConversionError> {
        match value {
            ...
            30 => Ok(Self::r30),
            31 => Ok(Self::r31),
            x => Err(IntRegisterConversionError::new_out_of_range(x, 32, "Cop2")),
        }
    }
    #[must_use]
...
mod tests {
    ...
    fn check_descriptor_valid() {
        for (i, x) in COP2.iter().enumerate() {
