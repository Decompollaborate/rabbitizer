...
impl Instruction {
    ...
    pub fn get_r4000allegrex_vcmp_s_args(
        ...
        {
            Some(self.get_r4000allegrex_vcmp_s_args_impl())
        } else {
            None
        }
    }
    ...
    #[must_use]
    pub(crate) fn get_r4000allegrex_vcmp_s_args_impl(
        &self,
    ) -> (
        R4000AllegrexVCond,
        Option<R4000AllegrexS>,
        ...
        let cond = self.field().r4000allegrex_vcmp_cond_impl();
        let vs = self.field().r4000allegrex_s_vs_impl();
        let vt = self.field().r4000allegrex_s_vs_impl();
    ...
    pub fn get_r4000allegrex_vcmp_p_args(
        ...
        {
            Some(self.get_r4000allegrex_vcmp_p_args_impl())
        } else {
            None
        }
    }
    ...
    #[must_use]
    pub(crate) fn get_r4000allegrex_vcmp_p_args_impl(
        &self,
    ) -> (
        R4000AllegrexVCond,
        Option<R4000AllegrexV2D>,
        ...
        let cond = self.field().r4000allegrex_vcmp_cond_impl();
        let vs = self.field().r4000allegrex_p_vs_impl();
        let vt = self.field().r4000allegrex_p_vs_impl();
    ...
    pub fn get_r4000allegrex_vcmp_t_args(
        ...
        {
            Some(self.get_r4000allegrex_vcmp_t_args_impl())
        } else {
            None
        }
    }
    ...
    #[must_use]
    pub(crate) fn get_r4000allegrex_vcmp_t_args_impl(
        &self,
    ) -> (
        R4000AllegrexVCond,
        Option<R4000AllegrexV3D>,
        ...
        let cond = self.field().r4000allegrex_vcmp_cond_impl();
        let vs = self.field().r4000allegrex_t_vs_impl();
        let vt = self.field().r4000allegrex_t_vs_impl();
    ...
    pub fn get_r4000allegrex_vcmp_q_args(
        ...
        {
            Some(self.get_r4000allegrex_vcmp_q_args_impl())
        } else {
            None
        }
    }
    ...
    #[must_use]
    pub(crate) fn get_r4000allegrex_vcmp_q_args_impl(
        &self,
    ) -> (
        R4000AllegrexVCond,
        Option<R4000AllegrexV4D>,
        ...
        let cond = self.field().r4000allegrex_vcmp_cond_impl();
        let vs = self.field().r4000allegrex_q_vs_impl();
        let vt = self.field().r4000allegrex_q_vs_impl();
