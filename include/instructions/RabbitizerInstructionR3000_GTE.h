...
#ifndef RABBITIZER_INSTRUCTION_R3000_GTE_H
#define RABBITIZER_INSTRUCTION_R3000_GTE_H
#pragma once
...
NON_NULL(1)
void RabbitizerInstructionR3000_GTE_processUniqueId_MMI(RabbitizerInstruction *self);
#endif
