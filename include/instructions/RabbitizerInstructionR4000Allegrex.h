...
#define RAB_INSTR_R4000ALLEGREX_GET_vfpu6_fmt(self)                             (SHIFTR((self)->word, 23,  3))
...
#define RAB_INSTR_R4000ALLEGREX_PACK_vfpu6_fmt(word, value)                     (BITREPACK((word), (value), 23,  2))
