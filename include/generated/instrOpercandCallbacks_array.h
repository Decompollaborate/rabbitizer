...
const OperandCallback instrOpercandCallbacks[] = {
    ...
    [RAB_OPERAND_r4000allegrex_vt_6] = RabbitizerOperandType_process_r4000allegrex_vt_6,
    [RAB_OPERAND_r4000allegrex_vt_7] = RabbitizerOperandType_process_r4000allegrex_vt_7,
