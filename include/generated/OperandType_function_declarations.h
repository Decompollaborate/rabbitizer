...
#define OperandType_function_declarations_h_automatic
    ...
    size_t RabbitizerOperandType_process_r4000allegrex_cop3cd (const struct RabbitizerInstruction *self, char *dst, const char *immOverride, size_t immOverrideLength);
