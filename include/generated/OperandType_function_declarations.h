...
#define OperandType_function_declarations_h_automatic
    ...
    size_t RabbitizerOperandType_process_r4000allegrex_vt_6 (const struct RabbitizerInstruction *self, char *dst, const char *immOverride, size_t immOverrideLength);
    size_t RabbitizerOperandType_process_r4000allegrex_vt_7 (const struct RabbitizerInstruction *self, char *dst, const char *immOverride, size_t immOverrideLength);
