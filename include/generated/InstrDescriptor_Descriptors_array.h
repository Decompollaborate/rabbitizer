...
const RabbitizerInstrDescriptor RabbitizerInstrDescriptor_Descriptors[] = {
    ...
    [RABBITIZER_INSTR_ID_cpu_wsbh] = { .operands={RAB_OPERAND_cpu_rd, RAB_OPERAND_cpu_rt}, .instrType=RABBITIZER_INSTR_TYPE_R, .modifiesRd=true, .readsRt=true },
    [RABBITIZER_INSTR_ID_cpu_wsbw] = { .operands={RAB_OPERAND_cpu_rd, RAB_OPERAND_cpu_rt}, .instrType=RABBITIZER_INSTR_TYPE_R, .modifiesRd=true, .readsRt=true },
    [RABBITIZER_INSTR_ID_cpu_seb] = { .operands={RAB_OPERAND_cpu_rd, RAB_OPERAND_cpu_rt}, .instrType=RABBITIZER_INSTR_TYPE_R, .modifiesRd=true, .readsRt=true },
    [RABBITIZER_INSTR_ID_cpu_seh] = { .operands={RAB_OPERAND_cpu_rd, RAB_OPERAND_cpu_rt}, .instrType=RABBITIZER_INSTR_TYPE_R, .modifiesRd=true, .readsRt=true },
    [RABBITIZER_INSTR_ID_cpu_bitrev] = { .operands={RAB_OPERAND_cpu_rd, RAB_OPERAND_cpu_rt}, .instrType=RABBITIZER_INSTR_TYPE_R, .modifiesRd=true, .readsRt=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc2f] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc2t] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc2fl] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true, .isBranchLikely=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc2tl] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true, .isBranchLikely=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_mfc3] = { .operands={RAB_OPERAND_cpu_rt, RAB_OPERAND_r4000allegrex_cop3cd}, .modifiesRt=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_mtc3] = { .operands={RAB_OPERAND_cpu_rt, RAB_OPERAND_r4000allegrex_cop3cd}, .readsRt=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_cfc3] = { .operands={RAB_OPERAND_cpu_rt, RAB_OPERAND_r4000allegrex_cop3cd}, .modifiesRt=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_ctc3] = { .operands={RAB_OPERAND_cpu_rt, RAB_OPERAND_r4000allegrex_cop3cd}, .readsRt=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc3f] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc3t] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc3fl] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true, .isBranchLikely=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_bc3tl] = { .operands={RAB_OPERAND_cpu_branch_target_label}, .instrType=RABBITIZER_INSTR_TYPE_UNKNOWN, .isBranch=true, .isBranchLikely=true },
