...
const RabbitizerInstrDescriptor RabbitizerInstrDescriptor_Descriptors[] = {
    ...
    [RABBITIZER_INSTR_ID_r4000allegrex_lv_q] = { .operands={RAB_OPERAND_r4000allegrex_vt_6, RAB_OPERAND_r4000allegrex_offset14_base}, .instrType=RABBITIZER_INSTR_TYPE_I, .readsRs=true },
    [RABBITIZER_INSTR_ID_r4000allegrex_sv_q] = { .operands={RAB_OPERAND_r4000allegrex_vt_6, RAB_OPERAND_r4000allegrex_offset14_base_maybe_wb}, .instrType=RABBITIZER_INSTR_TYPE_I, .modifiesRs=true },
