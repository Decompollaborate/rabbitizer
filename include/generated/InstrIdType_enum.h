...
typedef enum RabInstrIdType {
    ...
    RAB_INSTR_ID_TYPE_ALLEGREX_INVALID,
    RAB_INSTR_ID_TYPE_ALLEGREX_NORMAL,
    RAB_INSTR_ID_TYPE_ALLEGREX_SPECIAL,
    RAB_INSTR_ID_TYPE_ALLEGREX_SPECIAL_RS,
    RAB_INSTR_ID_TYPE_ALLEGREX_SPECIAL_SA,
    RAB_INSTR_ID_TYPE_ALLEGREX_REGIMM,
    RAB_INSTR_ID_TYPE_ALLEGREX_SPECIAL2,
    RAB_INSTR_ID_TYPE_ALLEGREX_SPECIAL3,
    RAB_INSTR_ID_TYPE_ALLEGREX_SPECIAL3_BSHFL,
    RAB_INSTR_ID_TYPE_ALLEGREX_COP0,
    RAB_INSTR_ID_TYPE_ALLEGREX_COP1,
    RAB_INSTR_ID_TYPE_ALLEGREX_COP2,
    RAB_INSTR_ID_TYPE_ALLEGREX_COP3,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU0,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU1,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU3,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU4,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU5,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU6,
    RAB_INSTR_ID_TYPE_ALLEGREX_VFPU7,
